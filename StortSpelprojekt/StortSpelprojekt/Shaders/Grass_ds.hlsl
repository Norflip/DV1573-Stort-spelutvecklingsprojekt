	...
	float2 uv : SV_DomainLocation)
{
	...
	output.bladeHeight = grassHeightMap.SampleLevel(LinearSampler, uvPlane, 0).r * 0.5;//0.5 == grassRadius
	...
	float disp = /*grassDisplacement*/ 2* pow(uv.x, 1.0); //2 == grassDisplacement/Length
