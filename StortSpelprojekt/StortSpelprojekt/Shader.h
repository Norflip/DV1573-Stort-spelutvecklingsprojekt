...
private:
	LPCWSTR pixelPath, vertexPath, geometryPath, skeletonPath, alphaPath, instancePath;
	LPCSTR pixelEntry, vertexEntry, geometryEntry, skeletonEntry, alphaEntry, instanceEntry;
