...
void GameScene::InitializeObjects()
{
	...
	baseComponent->SetTrack(SkeletonStateMachine::IDLE, SkeletonStateMachine::NONE, false);
	legsComponent->SetTrack(SkeletonStateMachine::IDLE, SkeletonStateMachine::NONE,false);
